...
<body>
	...
	<div id='daMettereASinistra'>
		...
		<div id='daMostrareSeOcchiali'>
			<form action="article" method='get'>
				<input type="hidden" name="tipo" value="O" /> <input type="hidden"
					name="daCercare" <% if(daCercare!=null){%> value="<%=daCercare%>"
					<%} %> /> <label for="marca">Marca:</label> <select name="marca">
				...
				<label for="sesso">Sesso:</label> <select name="sesso">
					...
					name="colore" value="" /> <input type='submit' value='Search!' />
			</form>
		</div>
	...
	<div>
		<br>
		<br>Questo che segue è il primo tentativo di luca di usare ajax<br>Verrà
